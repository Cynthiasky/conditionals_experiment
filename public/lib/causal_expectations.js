...
function SetupWorld(){
	...
	// FUNCTION FOR CREATING BALLS
	 ...
	 if (visualize){
	  ...
	  "topWall", //userdata 
	  "public/images/longWall.png") //image
	  ...
	  "public/images/shortWall.png") //image
	  ...
	  b2Body.b2_staticBody, //what type of body
	  "topBlock", //userdata 
	  "public/images/block_red" + (Math.round((1-pA)*100)) + ".png") //image
	  ...
	  "public/images/block_red" + (Math.round((1-pB)*100)) + ".png") //image
...
function animateWorld()
{
	...
	if (counter == duration){
		for (var i = 0; i < bodies.length; i++) {
			...
			$('#simulate', parent.document).prop('disabled',false); //TODO: change to button click
			// var actor=actors[i];
			// stage.removeChild(actor);
		}
	}
